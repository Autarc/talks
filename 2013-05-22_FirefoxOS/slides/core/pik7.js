...
define("lib/controls", ["lib/emitter", "jquery"], function (e) {
    ...
    return t = function (e) {
        ...
        return __extends(t, e), t.prototype.nonTargets = ["a", "input", "textarea", "select", "button"], t.prototype.addKeyEvents = function () {
            ...
            var t;
            return t = e.keyCode, 37 === t || 33 === t ? (this.trigger("prev", e), this.stopEvent(e)) : 39 === t || 34 === t ? (this.trigger("next", e), this.stopEvent(e)) : 116 === t || 27 === t ? (this.trigger("toggleHidden", e), this.stopEvent(e)) : void 0
